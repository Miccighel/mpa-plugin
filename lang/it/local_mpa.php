...
$string['subfeedbackauthor'] = "Feedback dall'autore";
$string['assessment'] = "Valutazione";
$string['assid'] = "Identificatore";
$string['assfeedbackauthor'] = "Feedback dal valutatore";
$string['grade'] = "Voto";
$string['gradid'] = "Identificatore";
$string['gradedescription'] = "Criterio";
$string['peercomment'] = "Commento";
